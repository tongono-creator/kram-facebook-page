...
def generate_hook(detail, highlights):
    ...
    if API_ENABLED and active_client is not None:
        prompt = (
            "สร้างพาดหัวรีวิวสั้นภาษาไทย 2 บรรทัด คั่นด้วย '|' (บรรทัด 1 | บรรทัด 2)\n"
            "กฎ:\n"
            "- บรรทัด 1: คำโปรย/ชื่อเล่นสั้นๆ เป็นกันเอง (3-5 คำ)\n"
